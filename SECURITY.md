...
1. Going to the [Security tab](https://github.com/forepath/kublade/security) of this repository
...
For any security-related questions or concerns, please use the [Security tab](https://github.com/forepath/kublade/security) of this repository. 
